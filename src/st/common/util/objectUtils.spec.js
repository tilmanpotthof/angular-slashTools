...
describe('service', function () {
    ...
    describe('objectUtils.setProperty', function () {
        ...
        it('should set "github" in the non existing attribute "social"' +
            'to "http://github.com/tilmanpotthof"', inject(function (objectUtils) {
        ...
        it('should set "flying" in the non existing attribute "other.superpowers" to "Like a pro!"',
            inject(function (objectUtils) {
